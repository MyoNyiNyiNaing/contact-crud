...
import { useDeleteContactMutation, useGetSingleContactQuery } from "../redux/api/contactApi";
...
const Detail = () => {
  ...
  return (
    ...
    {toggleDelModal && <DeleteModal toggleDelModal={toggleDelModal} setToggleDelModal={setToggleDelModal} deleteContact={deleteContact} id={id}/>}
    <div className="w-[75%] mx-auto p-5">
      <div className=" m-10 flex justify-between">
        <div className=" flex items-center gap-10">
          <button className=" self-start text-xl" onClick={() => navigate(-1)}>
            <RxCross2 />
          </button>
          <img
        ...
        <div className=" flex items-center gap-8 self-end">
          <button className=" text-red-500 hover:scale-110 transition" onClick={()=> setToggleDelModal(!toggleDelModal)}>
            <BiTrash />
          </button>
      ...
      <div className=" m-10 flex items-center gap-10">
        <div className=" border rounded-lg p-4 w-[500px]">
          <h4 className=" text-lg mb-4 font-medium text-gray-500">Contact details</h4>
        ...
        <div className=" space-y-3">
            <h4 className=" flex items-center gap-3 text-gray-500 text-lg font-medium">History<BsQuestionCircle/></h4>
            <p className=" text-gray-500 text-sm">Last edited•Yesterday, 15:34</p>
            <p className=" text-gray-500 text-sm">Added to contacts•Yesterday, 15:34</p>
        </div>
      </div>
    </div>
    </>
